...
![](https://github.com/IvoDSBarros/Experimenting-NLP-on-rock-news-articles/blob/343d09dd3fb787d5556cd9eede57083698ed784d/output/visuals/data_architecture_diagram.png)
...
+ The hyperparameter optimization of the Scikit-learn LDA model, namely the parameters "n_components" and "learning_decay", was performed using the grid search method. Nevertheless, due to low interpretability of topics, the "n_components" parameter search was set as > 4.
