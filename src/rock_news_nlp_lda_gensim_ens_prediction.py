...
# clean_lst = tpp.text_preprocessing_to_gensim(lst)
# corpus_lst, corpus_tfidf_lst = lda_gens.corpus_bow(clean_lst, dictionary_train)
# vector = ens_lda_train[corpus_lst]

# for i in range(0,len(vector)):
#     print(vector[i])

# corpus_test = corpus[0]


# import pandas as pd
# path = r'C:\Users\HP\Desktop\Python\Projects\github_rock_news_nlp\data\web_scrapers'
# df_rock_news = pd.read_csv(f'{path}/rock_news.csv',sep=';')

# test = df_rock_news.loc[:20, ['title']]
# aaa = test['title'].to_list()

#     # df_temp = df_temp.loc[rng_start:rng_stop, [col_name]]
#     # return df_temp.to_list()


# print(len(df_rock_news))
...
# print(vector.print_topics())
# print(len(vector.get_topics()))