...
+ The hyperparameter optimization of the Scikit-learn LDA model, namely the parameters "n_components" and "learning_decay", was performed using the grid search method. Nevertheless, due to low interpretability of topics, the "n_components" search was set as > 4.
